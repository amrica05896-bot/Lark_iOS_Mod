...
# instance fields
.field private final a:Landroidx/emoji2/text/a$b;
...
.method private a(Landroid/content/Context;Lo/pn1;)Landroidx/emoji2/text/EmojiCompat$c;
    .locals 1
    ...
    .line 6
    .line 7
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/f;-><init>(Landroid/content/Context;Lo/pn1;)V
...
.method private d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lo/pn1;
    .locals 3
    ...
    .line 11
    invoke-direct {p0, p2}, Landroidx/emoji2/text/a$a;->b([Landroid/content/pm/Signature;)Ljava/util/List;
    ...
    .line 18
    .line 19
    invoke-direct {v1, v0, p1, v2, p2}, Lo/pn1;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method private static e()Landroidx/emoji2/text/a$b;
    .locals 2
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method private g(Landroid/content/pm/PackageManager;)Landroid/content/pm/ProviderInfo;
    ...
    .line 37
    invoke-direct {p0, v0}, Landroidx/emoji2/text/a$a;->f(Landroid/content/pm/ProviderInfo;)Z
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/EmojiCompat$c;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/a$a;->h(Landroid/content/Context;)Lo/pn1;
    ...
    .line 5
    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/a$a;->a(Landroid/content/Context;Lo/pn1;)Landroidx/emoji2/text/EmojiCompat$c;
...
.method public h(Landroid/content/Context;)Lo/pn1;
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 6
    .line 7
    invoke-static {p1, v0}, Lo/sx0;->j(Ljava/lang/Object;Ljava/lang/String;)V

    .line 8
    .line 9
    .line 10
    invoke-direct {p0, p1}, Landroidx/emoji2/text/a$a;->g(Landroid/content/pm/PackageManager;)Landroid/content/pm/ProviderInfo;
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/a$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lo/pn1;
