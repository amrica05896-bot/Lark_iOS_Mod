...
# direct methods
.method static synthetic lambda$makeDouble$3(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/DoublePredicate;)Lj$/util/stream/MatchOps$BooleanTerminalSink;
    .locals 1

    new-instance v0, Lj$/util/stream/MatchOps$4MatchSink;

    invoke-direct {v0, p0, p1}, Lj$/util/stream/MatchOps$4MatchSink;-><init>(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/DoublePredicate;)V

    return-object v0
.end method

.method static synthetic lambda$makeInt$1(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/IntPredicate;)Lj$/util/stream/MatchOps$BooleanTerminalSink;
    .locals 1

    new-instance v0, Lj$/util/stream/MatchOps$2MatchSink;

    invoke-direct {v0, p0, p1}, Lj$/util/stream/MatchOps$2MatchSink;-><init>(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/IntPredicate;)V

    return-object v0
.end method

.method static synthetic lambda$makeLong$2(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/LongPredicate;)Lj$/util/stream/MatchOps$BooleanTerminalSink;
    .locals 1

    new-instance v0, Lj$/util/stream/MatchOps$3MatchSink;

    invoke-direct {v0, p0, p1}, Lj$/util/stream/MatchOps$3MatchSink;-><init>(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/LongPredicate;)V
...
.method public static makeDouble(Lj$/util/function/DoublePredicate;Lj$/util/stream/MatchOps$MatchKind;)Lj$/util/stream/TerminalOp;
    ...
    invoke-direct {v2, p1, p0}, Lj$/util/stream/MatchOps$$ExternalSyntheticLambda2;-><init>(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/DoublePredicate;)V
...
.method public static makeInt(Lj$/util/function/IntPredicate;Lj$/util/stream/MatchOps$MatchKind;)Lj$/util/stream/TerminalOp;
    ...
    invoke-direct {v2, p1, p0}, Lj$/util/stream/MatchOps$$ExternalSyntheticLambda0;-><init>(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/IntPredicate;)V
...
.method public static makeLong(Lj$/util/function/LongPredicate;Lj$/util/stream/MatchOps$MatchKind;)Lj$/util/stream/TerminalOp;
    ...
    invoke-direct {v2, p1, p0}, Lj$/util/stream/MatchOps$$ExternalSyntheticLambda3;-><init>(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/LongPredicate;)V
...
.method public static makeRef(Lj$/util/function/Predicate;Lj$/util/stream/MatchOps$MatchKind;)Lj$/util/stream/TerminalOp;
    ...
    invoke-direct {v2, p1, p0}, Lj$/util/stream/MatchOps$$ExternalSyntheticLambda1;-><init>(Lj$/util/stream/MatchOps$MatchKind;Lj$/util/function/Predicate;)V
