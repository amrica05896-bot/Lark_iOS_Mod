...
.method public synthetic mapToDouble(Lj$/util/function/ToDoubleFunction;)Lj$/util/stream/DoubleStream;
    ...
    invoke-static {p1}, Lj$/util/function/ToDoubleFunction$Wrapper;->convert(Lj$/util/function/ToDoubleFunction;)Ljava/util/function/ToDoubleFunction;
...
.method public synthetic mapToInt(Lj$/util/function/ToIntFunction;)Lj$/util/stream/IntStream;
    ...
    invoke-static {p1}, Lj$/util/function/ToIntFunction$Wrapper;->convert(Lj$/util/function/ToIntFunction;)Ljava/util/function/ToIntFunction;
...
.method public synthetic mapToLong(Lj$/util/function/ToLongFunction;)Lj$/util/stream/LongStream;
    ...
    invoke-static {p1}, Lj$/util/function/ToLongFunction$Wrapper;->convert(Lj$/util/function/ToLongFunction;)Ljava/util/function/ToLongFunction;
...
.method public synthetic reduce(Lj$/util/function/BinaryOperator;)Lj$/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/function/BinaryOperator$Wrapper;->convert(Lj$/util/function/BinaryOperator;)Ljava/util/function/BinaryOperator;
...
.method public synthetic reduce(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lj$/util/function/BinaryOperator$Wrapper;->convert(Lj$/util/function/BinaryOperator;)Ljava/util/function/BinaryOperator;
...
.method public synthetic reduce(Ljava/lang/Object;Lj$/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/util/function/BinaryOperator$Wrapper;->convert(Lj$/util/function/BinaryOperator;)Ljava/util/function/BinaryOperator;
