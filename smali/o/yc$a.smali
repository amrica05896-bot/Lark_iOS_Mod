...
.method private g(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 2
    invoke-direct {p0, p1, v0}, Lo/yc$a;->h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 7
    .line 8
    invoke-static {p1, v2}, Lo/kp5;->c(Landroid/content/Context;I)I
    ...
    .line 13
    .line 14
    invoke-static {p1, v3}, Lo/kp5;->b(Landroid/content/Context;I)I
    ...
    .line 29
    .line 30
    invoke-static {v2, p2}, Lo/va0;->c(II)I
...
.method private i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 2
    .line 3
    invoke-static {p1, v0}, Lo/kp5;->c(Landroid/content/Context;I)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 7
    .line 8
    invoke-static {p1, v2}, Lo/kp5;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 38
    .line 39
    invoke-static {p1, v5}, Lo/kp5;->c(Landroid/content/Context;I)I
    ...
    .line 61
    .line 62
    invoke-static {p1, v2}, Lo/kp5;->b(Landroid/content/Context;I)I
...
.method private l(Lo/tn4;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    .param p1    # Lo/tn4;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 10
    .line 11
    invoke-virtual {p1, p2, v0}, Lo/tn4;->f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 16
    .line 17
    invoke-virtual {p1, p2, v1}, Lo/tn4;->f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 6
    .line 7
    invoke-static {}, Lo/yc;->a()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 11
    :cond_0
    invoke-static {p2, p3}, Lo/yc;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
# virtual methods
.method public a(Lo/tn4;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 3
    .param p1    # Lo/tn4;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 37
    .line 38
    invoke-direct {p0, p1, p2, p3}, Lo/yc$a;->l(Lo/tn4;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 5
    iget-object v1, p0, Lo/yc$a;->a:[I

    .line 6
    .line 7
    invoke-direct {p0, v1, p2}, Lo/yc$a;->f([II)Z
    ...
    .line 87
    invoke-static {p1, p2}, Lo/kp5;->c(Landroid/content/Context;I)I
    ...
    .line 91
    invoke-static {p1, v1}, Lo/yc;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 6
    .line 7
    invoke-static {p1, p2}, Lo/ad;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 26
    .line 27
    invoke-direct {p0, p1}, Lo/yc$a;->k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 35
    .line 36
    invoke-direct {p0, p1}, Lo/yc$a;->j(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 44
    .line 45
    invoke-direct {p0, p1}, Lo/yc$a;->g(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 53
    .line 54
    invoke-direct {p0, p1}, Lo/yc$a;->i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 68
    :cond_6
    iget-object v0, p0, Lo/yc$a;->b:[I

    .line 69
    .line 70
    invoke-direct {p0, v0, p2}, Lo/yc$a;->f([II)Z
    ...
    .line 77
    .line 78
    invoke-static {p1, p2}, Lo/kp5;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 30
    invoke-direct {p0, p2, v0, v4}, Lo/yc$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 47
    invoke-direct {p0, p2, v0, v3}, Lo/yc$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 55
    .line 56
    invoke-static {p1, p3}, Lo/kp5;->c(Landroid/content/Context;I)I
    ...
    .line 64
    invoke-direct {p0, p2, p1, p3}, Lo/yc$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 90
    .line 91
    invoke-static {p1, v0}, Lo/kp5;->b(Landroid/content/Context;I)I
